/**
 * Minimal placeholder — just enough page body to check the root layout (header, mega-menu,
 * theme toggle, footer, floating slots panel) together in a browser. Real Home page content
 * comes later.
 */
